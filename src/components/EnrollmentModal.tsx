    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative w-full max-w-2xl bg-[#15181b] rounded-2xl shadow-2xl border border-white/10 max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6 border-b border-white/10 flex-shrink-0">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">Inscreva-se na REAL BUILDER Academy</h2>
          <p className="text-gray-400 text-sm mb-6">Preencha o formulário abaixo para iniciar a sua jornada como um construtor certificado.</p>
          
          <div className="flex justify-between items-center mb-2">
            <span className="text-gray-400 text-xs font-semibold">Conclusão do formulário</span>
          ...
          {isSubmitted ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400">
                Obrigado pelo seu interesse. Notificá-lo-emos quando as inscrições abrirem.
              </p>
            </div>
          ) : (
            <>
              ...
              <section>
                <h3 className="text-[#FFB800] text-xs font-bold tracking-widest uppercase mb-4">INFORMAÇÕES PESSOAIS</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-white text-sm font-semibold mb-2">Primeiro Nome *</label>
                  ...
                  <div>
                    <label className="block text-white text-sm font-semibold mb-2">Apelido *</label>
                  ...
                  <div className="sm:col-span-2">
                    <label className="block text-white text-sm font-semibold mb-2">E-mail *</label>
                  ...
                  <div>
                    <label className="block text-white text-sm font-semibold mb-2">Telefone *</label>
              ...
              {/* SELECT YOUR COURSE */}
              <section>
                <h3 className="text-[#FFB800] text-xs font-bold tracking-widest uppercase mb-2">SELECIONE O SEU CURSO *</h3>
                <p className="text-gray-400 text-xs mb-4">Escolha em qual dos próximos cursos se gostaria de inscrever</p>
                ...
                <div className="space-y-3">
                  ...
                  <div onClick={() => setSelectedCourse('pladur')} className={`bg-[#111315] border ${selectedCourse === 'pladur' ? 'border-[#FFB800]' : 'border-white/10'} rounded-xl p-4 flex gap-4 cursor-pointer hover:border-[#FFB800]/50 transition-colors group`}>
                    ...
                    <div>
                      <h4 className="text-white font-bold text-sm">Fundamentos de Pladur e Gesso Cartonado</h4>
                      <p className="text-gray-400 text-xs mb-2">Pladur / Drywall</p>
                      <div className="flex items-center gap-2 text-xs">
                        <span className="text-[#FFB800] font-bold">15 vagas restantes</span>
                  ...
                  <div onClick={() => setSelectedCourse('tiles')} className={`bg-[#111315] border ${selectedCourse === 'tiles' ? 'border-[#FFB800]' : 'border-white/10'} rounded-xl p-4 flex gap-4 cursor-pointer hover:border-[#FFB800]/50 transition-colors group`}>
                    ...
                    <div>
                      <h4 className="text-white font-bold text-sm">Instalação Profissional de Azulejos</h4>
                      <p className="text-gray-400 text-xs mb-2">Azulejos e Ladrilhos</p>
                      <div className="flex items-center gap-2 text-xs">
                        <span className="text-[#FFB800] font-bold">15 vagas restantes</span>
                        <span className="text-gray-500">• PT/EN</span>
                      </div>
                  ...
                  <div onClick={() => setSelectedCourse('heating')} className={`bg-[#111315] border ${selectedCourse === 'heating' ? 'border-[#FFB800]' : 'border-white/10'} rounded-xl p-4 flex gap-4 cursor-pointer hover:border-[#FFB800]/50 transition-colors group`}>
                    ...
                    <div>
                      <h4 className="text-white font-bold text-sm">Instalação de Piso Radiante</h4>
                      <p className="text-gray-400 text-xs mb-2">Aquecimento de Piso</p>
                      <div className="flex items-center gap-2 text-xs">
                        <span className="text-[#FFB800] font-bold">15 vagas restantes</span>
                        <span className="text-gray-500">• PT/EN</span>
                      </div>
              ...
              {/* SKILLS ASSESSMENT */}
              <section>
                <h3 className="text-[#FFB800] text-xs font-bold tracking-widest uppercase mb-4">AVALIAÇÃO DE COMPETÊNCIAS</h3>
                <div className="space-y-4">
                  <div>
                    <label className="block text-white text-sm font-semibold mb-2">Competências de Leitura *</label>
                    <select name="readingSkills" required defaultValue="" className="w-full bg-[#111315] border border-white/10 rounded-lg p-3 text-white focus:border-[#FFB800] outline-none transition-colors text-sm appearance-none cursor-pointer">
                      <option value="" disabled>Selecione o seu nível de leitura</option>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-white text-sm font-semibold mb-2">Nível de Português *</label>
                      <select name="portugueseLevel" required defaultValue="" className="w-full bg-[#111315] border border-white/10 rounded-lg p-3 text-white focus:border-[#FFB800] outline-none transition-colors text-sm appearance-none cursor-pointer">
                        ...
                        <option value="intermediate">Intermédio (B1-B2)</option>
                        <option value="fluent">Fluente (C1-C2)</option>
                      </select>
                    </div>
                    <div>
                      <label className="block text-white text-sm font-semibold mb-2">Nível de Inglês *</label>
                  ...
                  <div>
                    <label className="block text-white text-sm font-semibold mb-2">Competências Digitais *</label>
                    <select name="digitalSkills" required defaultValue="" className="w-full bg-[#111315] border border-white/10 rounded-lg p-3 text-white focus:border-[#FFB800] outline-none transition-colors text-sm appearance-none cursor-pointer">
                      <option value="" disabled>Selecione o seu nível de competências digitais</option>
                      <option value="basic">Básico (Consegue usar apps de smartphone)</option>
                      <option value="intermediate">Intermédio (Consegue usar e-mail, software básico)</option>
                      <option value="advanced">Avançado (À vontade com novo software)</option>
                    </select>
                  </div>
                </div>
              </section>
              ...
              <section>
                <h3 className="text-[#FFB800] text-xs font-bold tracking-widest uppercase mb-4">EXPERIÊNCIA EM CONSTRUÇÃO</h3>
                
                <div className="mb-6">
                  <label className="flex items-start gap-3 cursor-pointer group">
                    <input type="checkbox" name="experience" className="accent-[#FFB800] w-5 h-5 mt-0.5" />
                    <div>
                      <span className="text-white text-sm font-bold block mb-1">Tenho mais de 1 ano de experiência em construção</span>
                      <span className="text-gray-400 text-xs">Experiência prévia em construção, renovação ou áreas relacionadas</span>
                    </div>
                  </label>
                </div>

                <div>
                  <label className="block text-white text-sm font-semibold mb-2">Carregar Documentação de Experiência (opcional)</label>
                  <div className="relative">
                    ...
                    <div className="border border-dashed border-white/20 rounded-xl p-8 text-center hover:border-[#FFB800]/50 transition-colors cursor-pointer bg-[#111315]/50">
                      ...
                      <p className="text-gray-400 text-sm">Clique para carregar CV, certificados ou referências de trabalho</p>
                    </div>
                  </div>
                  <p className="text-gray-500 text-[10px] mt-2">PDF, DOC, DOCX, JPG ou PNG (máx. 10MB)</p>
                </div>
              </section>
              ...
              <section>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-[#FFB800] text-xs font-bold tracking-widest uppercase">PRECISA DE ASSISTÊNCIA?</h3>
                </div>
                ...
                <div className="bg-[#FFB800]/5 border border-[#FFB800]/20 rounded-xl p-4">
                  <label className="flex items-start gap-3 cursor-pointer group">
                    ...
                    <div>
                      <span className="text-white text-sm font-bold block mb-1">Faltam-me alguns requisitos e preciso de assistência</span>
                      <span className="text-gray-400 text-xs leading-relaxed block">Não se preocupe! Podemos ajudá-lo a melhorar as suas competências antes do programa. Se não tiver a documentação necessária, completará um teste prático no local.</span>
                    </div>
                  </label>
                </div>
              </section>
              ...
              {/* COMMITMENT */}
              <section>
                <h3 className="text-[#FFB800] text-xs font-bold tracking-widest uppercase mb-4">COMPROMISSO</h3>
                ...
                <div className="bg-[#111315] border border-white/10 rounded-xl p-4">
                  <label className="flex items-start gap-3 cursor-pointer group">
                    ...
                    <div>
                      <span className="text-white text-sm font-bold block mb-1">Tenho a mentalidade para mudar a minha vida *</span>
                      <span className="text-gray-400 text-xs leading-relaxed block">Estou comprometido em aprender, crescer e construir uma carreira de sucesso como um REAL BUILDER certificado</span>
                    </div>
                  </label>
                </div>
              </section>
              ...
              <div className="bg-[#FFB800]/10 border border-[#FFB800]/30 rounded-xl p-5">
                <div className="flex items-center gap-2 text-[#FFB800] font-bold mb-2">
                  <Clock size={18} />
                  Inscrições Atualmente Fechadas
                </div>
                <p className="text-gray-400 text-sm mb-4">
                  Obrigado pelo seu interesse! As inscrições para novos cursos abrirão em breve. Deixe os seus dados abaixo e notificá-lo-emos quando as inscrições abrirem.
                </p>
                <button type="submit" disabled={isSubmitting} className="w-full bg-gradient-to-r from-[#FFB800] to-[#FF9500] text-black font-bold py-3 rounded-lg flex items-center justify-center gap-2 hover:opacity-90 transition-opacity text-sm disabled:opacity-70 disabled:cursor-not-allowed">
                  <Mail size={16} />
                  {isSubmitting ? 'A PROCESSAR...' : 'AVISE-ME QUANDO AS INSCRIÇÕES ABRIREM'}
                </button>
              </div>
            </>
          )}
