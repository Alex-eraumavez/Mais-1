          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <div className="h-48 bg-white relative w-full">
                <img 
                  ...
                  alt={t('mobility.items.mobile_toolbox.name')} 
              ...
              <div className="p-6 flex flex-col items-center text-center flex-grow">
                <div className="flex items-center gap-2 text-white font-bold mb-2">
                  ...
                  {t('mobility.items.mobile_toolbox.name')}
                </div>
                <div className="text-gray-500 text-[10px] font-bold tracking-widest uppercase mb-6">
                  {t('mobility.items.mobile_toolbox.badge')}
                </div>
                <div className="mt-auto flex items-baseline gap-1">
                  <span className="text-[#FFB800] text-3xl font-bold">{t('mobility.items.mobile_toolbox.price')}</span>
                  <span className="text-gray-500 text-xs">{t('mobility.perMonth')}</span>
                </div>
              </div>
            </button>
            ...
            >
              <div className="h-48 bg-gray-300 relative w-full">
                <img 
                  ...
                  alt={t('mobility.items.electric_3_wheeler.name')} 
                  className="w-full h-full object-cover"
                  referrerPolicy="no-referrer"
                />
              </div>
              <div className="p-6 flex flex-col items-center text-center flex-grow">
                <div className="flex items-center gap-2 text-white font-bold mb-2">
                  ...
                  {t('mobility.items.electric_3_wheeler.name')}
                </div>
                <div className="text-gray-500 text-[10px] font-bold tracking-widest uppercase mb-6">
                  {t('mobility.items.electric_3_wheeler.badge')}
                </div>
                <div className="mt-auto flex items-baseline gap-1">
                  <span className="text-[#FFB800] text-3xl font-bold">{t('mobility.items.electric_3_wheeler.price')}</span>
                  <span className="text-gray-500 text-xs">{t('mobility.perMonth')}</span>
                </div>
              </div>
            </button>
            ...
            >
              <div className="absolute top-0 left-0 right-0 bg-[#FFB800] text-black text-[10px] font-bold text-center py-1 z-10 tracking-widest uppercase">
                {t('mobility.items.tool_buggy.popular')}
              </div>
              <div className="h-48 bg-gray-400 relative mt-6 w-full">
                <img 
                  ...
                  alt={t('mobility.items.tool_buggy.name')} 
                  className="w-full h-full object-cover"
                  referrerPolicy="no-referrer"
                />
              </div>
              <div className="p-6 flex flex-col items-center text-center flex-grow">
                <div className="flex items-center gap-2 text-white font-bold mb-2">
                  ...
                  {t('mobility.items.tool_buggy.name')}
                </div>
                <div className="text-gray-500 text-[10px] font-bold tracking-widest uppercase mb-6">
                  {t('mobility.items.tool_buggy.badge')}
                </div>
                <div className="mt-auto flex items-baseline gap-1">
                  <span className="text-[#FFB800] text-3xl font-bold">{t('mobility.items.tool_buggy.price')}</span>
                  <span className="text-gray-500 text-xs">{t('mobility.perMonth')}</span>
                </div>
              </div>
            </button>
            ...
            >
              <div className="h-48 bg-gray-500 relative w-full">
                <img 
                  ...
                  alt={t('mobility.items.tool_van.name')} 
                  className="w-full h-full object-cover"
                  referrerPolicy="no-referrer"
                />
              </div>
              <div className="p-6 flex flex-col items-center text-center flex-grow">
                <div className="flex items-center gap-2 text-white font-bold mb-2">
                  ...
                  {t('mobility.items.tool_van.name')}
                </div>
                <div className="text-gray-500 text-[10px] font-bold tracking-widest uppercase mb-6">
                  {t('mobility.items.tool_van.badge')}
                </div>
                <div className="mt-auto flex items-baseline gap-1">
                  <span className="text-[#FFB800] text-3xl font-bold">{t('mobility.items.tool_van.price')}</span>
                  <span className="text-gray-500 text-xs">{t('mobility.perMonth')}</span>
                </div>
              </div>
            </button>
