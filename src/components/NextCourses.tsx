      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="p-8 relative flex flex-col h-full bg-[#1a1d21] rounded-2xl border border-white/5 hover:border-white/10 transition-colors">
            ...
            <div className="text-[#FFB800] text-xs font-bold tracking-widest uppercase mb-2">{t('nextCourses.deadline.badge')}</div>
            <h3 className="text-2xl font-bold text-white mb-8">{t('nextCourses.deadline.title')}</h3>
            
            <div className="space-y-4 mb-8">
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                <span className="text-gray-500 text-sm">{t('nextCourses.deadline.date')}</span>
                <span className="text-white text-sm font-medium">{t('nextCourses.deadline.dateValue')}</span>
              </div>
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                <span className="text-gray-500 text-sm">{t('nextCourses.deadline.time')}</span>
                <span className="text-white text-sm font-medium">{t('nextCourses.deadline.timeValue')}</span>
              </div>
              <div className="flex justify-between items-center pt-2">
                <div className="flex items-center gap-2 md:gap-3 w-full justify-between">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-gray-400 text-[8px] tracking-widest">{t('nextCourses.deadline.days')}</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-gray-400 text-[8px] tracking-widest">{t('nextCourses.deadline.hours')}</span>
                  </div>
                  <span className="text-white/20 text-xl font-light pb-2">:</span>
                  <div className="flex flex-col items-center">
                    <span className="text-[#FFB800] text-xl font-black">{pad(timeLeft.minutes)}</span>
                    <span className="text-gray-400 text-[8px] tracking-widest">{t('nextCourses.deadline.mins')}</span>
                  </div>
                  <span className="text-white/20 text-xl font-light pb-2">:</span>
                  <div className="flex flex-col items-center">
                    <span className="text-[#FFB800] text-xl font-black">{pad(timeLeft.seconds)}</span>
                    <span className="text-gray-400 text-[8px] tracking-widest">{t('nextCourses.deadline.secs')}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="p-8 relative flex flex-col h-full bg-[#1a1d21] rounded-2xl border border-white/5 hover:border-white/10 transition-colors">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-gray-400 text-xs font-medium mb-6 w-fit">
              ...
              {t('nextCourses.upcoming.badge')}
            </div>
            <div className="text-[#FFB800] text-xs font-bold tracking-widest uppercase mb-2">{t('nextCourses.upcoming.season')}</div>
            <h3 className="text-2xl font-bold text-white mb-8">{t('nextCourses.upcoming.title')}</h3>
            
            <div className="space-y-4 mb-8">
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                <span className="text-gray-500 text-sm">{t('nextCourses.upcoming.date')}</span>
                <span className="text-white text-sm font-medium">{t('nextCourses.upcoming.dateValue')}</span>
              </div>
              <div className="flex justify-between items-center border-b border-white/5 pb-4">
                <span className="text-gray-500 text-sm">{t('nextCourses.upcoming.courses')}</span>
                <span className="text-white text-sm font-medium italic">{t('nextCourses.upcoming.toBeDefined')}</span>
              </div>
            </div>
          ...
          <div className="p-8 relative flex flex-col h-full bg-[#1a1d21] rounded-2xl border border-white/5">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-4 p-4 rounded-xl bg-[#FFB800]/5 border border-[#FFB800]/10">
                ...
                <div>
                  <div className="text-white font-bold text-sm">{t('nextCourses.deadline.title')}</div>
                  <div className="text-gray-400 text-xs mt-0.5">{t('nextCourses.deadline.timeValue')}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5">
                ...
                <div className="w-px h-10 bg-white/10"></div>
                <div>
                  <div className="text-white font-bold text-sm">{t('nextCourses.upcoming.title')}</div>
                  <div className="text-gray-400 text-xs mt-0.5 italic">{t('nextCourses.upcoming.toBeDefined')}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5">
                ...
                <div className="w-px h-10 bg-white/10"></div>
                <div>
                  <div className="text-white font-bold text-sm">{t('nextCourses.calendar.nextCoursesStart')}</div>
                  <div className="text-gray-400 text-xs mt-0.5 italic">{t('nextCourses.upcoming.toBeDefined')}</div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#111315] border border-white/10 rounded-none w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden shadow-2xl">
            ...
            <div className="flex items-center justify-between p-8 border-b border-white/10">
              <div className="flex items-center gap-3">
                <div>
                  <h3 className="text-xl font-semibold text-white tracking-tight">{t('nextCourses.calendar.modalTitle')}</h3>
                  <p className="text-gray-500 text-sm mt-1">{t('nextCourses.calendar.modalSubtitle')}</p>
                </div>
              </div>
              <button 
              ...
              <div className="space-y-12">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-gray-400 tracking-widest uppercase mb-6 flex items-center gap-4">
                    {t('nextCourses.calendar.months.apr')} 2026
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="border-2 border-[#FFB800] p-6 flex gap-6 bg-[#FFB800]/5 transition-colors">
                      ...
                      <div>
                        ...
                        <div className="text-white font-semibold mb-2">{t('nextCourses.deadline.title')}</div>
                        <div className="text-gray-400 text-xs">{t('nextCourses.deadline.timeValue')}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h4 className="text-sm font-semibold text-gray-400 tracking-widest uppercase mb-6 flex items-center gap-4">
                    {t('nextCourses.calendar.months.may')} 2026
                    <span className="h-[1px] flex-1 bg-white/10"></span>
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="border border-white/10 p-6 flex gap-6 hover:border-white/30 transition-colors">
                      ...
                      <div>
                        <div className="text-xs text-gray-500 font-bold tracking-widest uppercase mb-2">{t('nextCourses.calendar.newSeason')}</div>
                        <div className="text-white font-semibold mb-2">{t('nextCourses.upcoming.title')}</div>
                        <div className="text-gray-400 text-xs italic">{t('nextCourses.upcoming.toBeDefined')}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h4 className="text-sm font-semibold text-gray-400 tracking-widest uppercase mb-6 flex items-center gap-4">
                    {t('nextCourses.calendar.months.jun')} 2026
                    <span className="h-[1px] flex-1 bg-white/10"></span>
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="border border-white/10 p-6 flex gap-6 hover:border-white/30 transition-colors">
                      ...
                      <div>
                        ...
                        <div className="text-white font-semibold mb-2">{t('nextCourses.calendar.nextCoursesStart')}</div>
                        <div className="text-gray-400 text-xs italic">{t('nextCourses.upcoming.toBeDefined')}</div>
                      </div>
                    </div>
                  </div>
