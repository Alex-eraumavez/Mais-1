    ...
    <section id="hero" className="relative h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 w-full pb-20">
        ...
        >
          ...
          <p className="text-gray-300 text-base md:text-lg mb-8 max-w-xl leading-relaxed whitespace-pre-line">
            {t('hero.description')}
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="relative group overflow-hidden border border-white/20 text-white px-8 py-4 rounded-lg text-sm font-bold tracking-wider transition-all hover:border-[#FFB800]/50"
            >
