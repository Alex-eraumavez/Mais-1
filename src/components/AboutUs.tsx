        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="bg-[#111315] border border-white/5 rounded-2xl p-8 flex flex-col items-center justify-center text-center group hover:border-[#FFB800]/30 transition-colors duration-300">
              ...
              <div className="text-gray-500 text-xs font-bold tracking-widest uppercase">{t('about.stats.courses')}</div>
            </div>
            ...
            <div className="bg-[#111315] border border-white/5 rounded-2xl p-8 flex flex-col items-center justify-center text-center group hover:border-[#FFB800]/30 transition-colors duration-300 sm:translate-y-8">
              ...
              <div className="text-gray-500 text-xs font-bold tracking-widest uppercase">{t('about.stats.graduates')}</div>
            </div>
            ...
            <div className="bg-[#111315] border border-white/5 rounded-2xl p-8 flex flex-col items-center justify-center text-center group hover:border-[#FFB800]/30 transition-colors duration-300">
              ...
              <div className="text-gray-500 text-xs font-bold tracking-widest uppercase">{t('about.stats.jobRate')}</div>
            </div>
            ...
            <div className="bg-[#111315] border border-white/5 rounded-2xl p-8 flex flex-col items-center justify-center text-center group hover:border-[#FFB800]/30 transition-colors duration-300 sm:translate-y-8">
              ...
              <div className="text-gray-500 text-xs font-bold tracking-widest uppercase">{t('about.stats.partners')}</div>
            </div>
          </motion.div>
        </div>
      </div>
