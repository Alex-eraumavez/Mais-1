      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4">
            <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-2">{t('nav.contact')}</h4>
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link to="/faq" onClick={scrollToTop} className="hover:text-white transition-colors w-fit">{t('nav.faq')}</Link>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-start text-xs gap-2 md:gap-4">
          <p>© {new Date().getFullYear()} Real Builder Academy. {t('footer.rights')}</p>
